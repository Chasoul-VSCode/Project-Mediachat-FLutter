...
exports.createChat = (req, res) => {
    ...
    // Insert chat into database with Jakarta time
    const query = 'INSERT INTO chats (id_users, chat, date, for_users, images, voice_note) VALUES (?, ?, ?, ?, ?, ?)';
    dbConnection.query(query, [id_users, chat, jakartaTime, for_users, images, voice_note], (err, result) => {
        if (err) {
